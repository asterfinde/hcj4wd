...
(function () {
  ...
  for (var i = 0; i < names.length; i++) {
    ...
    // STEP 12: Compare the 'firstLetter' retrieved in STEP 11 to lower case 'j'
    if (firstLetter == 'j') {
      // call byeSpeaker's 'speak' method with the current name in the loop
      byeSpeaker.speak(names[i]);
    } else {
      // call helloSpeaker's 'speak' method with the current name in the loop
